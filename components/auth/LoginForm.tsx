    ...
    >
      <motion.div variants={item} className="mb-7">
        ...
        <p className="mt-2 text-[13px] leading-[1.6] text-text3">
          Sign in with AutoX to manage adapters, connections and the correlated inventory.
        </p>
      </motion.div>
      ...
      <motion.div variants={item} className="mt-6 border-t border-hair pt-4">
        <p className="text-[11.5px] leading-[1.6] text-text3">
          Access is managed centrally through AutoX SSO. No account? Ask an
          administrator to grant you access to this application.
        </p>
      </motion.div>
    </motion.div>
  );
